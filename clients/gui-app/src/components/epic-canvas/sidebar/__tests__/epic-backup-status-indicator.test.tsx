...
// Only the no-cloud-task selector is pinned - the open-epic store context it
// would need for real is the session's, which these tests do not stand up.
// The agent-activity read stays real against the registry the tests DO use.
