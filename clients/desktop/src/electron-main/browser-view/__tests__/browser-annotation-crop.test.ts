...
class FakeCropImage implements AnnotationCapturedImage {
  croppedWith: AnnotationCropRect | null = null;
...
class EmptyPngImage implements AnnotationCapturedImage {
  getSize(): { readonly width: number; readonly height: number } {
  ...
  crop(_rect: AnnotationCropRect): AnnotationCapturedImage {
    return this;
  }
